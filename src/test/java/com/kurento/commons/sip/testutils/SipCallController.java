...
public class SipCallController implements CallListener {
	...
	private EventListener sipCallListener;

	public SipCallController(String id) {
		sipCallListener = new EventListener("Call-" + id);
	}
	...
	public CallEvent pollSipEndPointEvent(int timeoutSec)
